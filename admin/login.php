...
<head>
    <meta charset="UTF-8">
    <title>Login Administrator Pilkasis | SMA Pro An-Nizhomiyah</title>
    ...
    <div class="cont">
        <div class="demo">
            ...
            <path d="M0,20 20,20 20,8 0,8z M10,13 10,16z M4,8 a6,8 0 0,1 12,0" />
                        ...
                        <div class="login__row" name="ingat" id="ingat">
                            <input type="checkbox" name="ingat" />&nbsp;Ingat saya (1 Pekan)
                        </div>
